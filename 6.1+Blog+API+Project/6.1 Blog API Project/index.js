...
app.post("/posts", (req, res)=>{
  ...
  const newPostId = parseInt(posts.length+1)
...
console.log(newPostId);
  ...
  const updatedArray = posts.push(newPost);
...
app.patch("/posts/:id", (req, res)=>{
  ...
  const updatedPost = {
    id: postId,
    title:newPostTitle || foundPost.title,
    content: newPostContent || foundPost.content,
    author:newPostAuthor || foundPost.author,
    date: currentDate,
  };
